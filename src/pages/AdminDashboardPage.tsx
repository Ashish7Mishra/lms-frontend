...
import { Users, GraduationCap, BookOpen, UserCheck, TrendingUp, BarChart3, Settings, ChevronRight } from 'lucide-react';
  ...
  <div className="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-6 border border-gray-100 hover:-translate-y-2 cursor-pointer overflow-hidden">
    ...
    <div className="relative z-10">
      <div className="flex items-start justify-between mb-4">
        <div className={`${iconBg} p-4 rounded-xl shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
          <Icon className="w-7 h-7 text-white" />
        </div>
        <div className="flex items-center space-x-1 px-3 py-1.5 bg-gradient-to-r from-green-400 to-emerald-500 text-white rounded-full text-xs font-bold shadow-md group-hover:scale-110 transition-transform duration-300">
          <TrendingUp className="w-3 h-3" />
          <span>+0</span>
        </div>
      </div>
      <h3 className={`text-sm font-bold mb-2 bg-gradient-to-r ${gradient} bg-clip-text text-transparent group-hover:scale-105 transition-all duration-300`}>{title}</h3>
      <p className={`text-5xl font-black bg-gradient-to-r ${gradient} bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300 inline-block drop-shadow-lg`}>{value}</p>
    </div>
  </div>
);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 sm:p-6 lg:p-8">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">Dashboard</h1>
          <p className="text-sm sm:text-base text-gray-600 mt-2 font-medium">Welcome back, Admin! 👋</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-100">
          <h2 className="text-lg sm:text-xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4 sm:mb-6">Quick Stats</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="group p-4 rounded-xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 border-l-4 border-blue-500 hover:shadow-md">
              <p className="text-xs sm:text-sm text-gray-600 font-medium mb-2">Average Enrollments per Course</p>
            ...
            <div className="group p-4 rounded-xl hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all duration-300 border-l-4 border-green-500 hover:shadow-md">
              <p className="text-xs sm:text-sm text-gray-600 font-medium mb-2">Student to Instructor Ratio</p>
            ...
            <div className="group p-4 rounded-xl hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 border-l-4 border-purple-500 hover:shadow-md">
              <p className="text-xs sm:text-sm text-gray-600 font-medium mb-2">Courses per Instructor</p>
